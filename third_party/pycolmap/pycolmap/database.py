...
CREATE_ALL = "; ".join([
    CREATE_CAMERAS_TABLE, CREATE_DESCRIPTORS_TABLE, CREATE_IMAGES_TABLE,
    CREATE_INLIER_MATCHES_TABLE, CREATE_KEYPOINTS_TABLE, CREATE_MATCHES_TABLE,
    CREATE_NAME_INDEX
])
...
def add_inlier_matches(db,
  ...
  db.execute("INSERT INTO inlier_matches VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
             ...
             (array_to_blob(matches), config, F, E, H))
